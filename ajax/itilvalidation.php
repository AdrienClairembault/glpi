...
echo json_encode(array_merge($template->fields, [
    'validatortype'   => $itemtype ?? null,
    'groups_id'       => isset($itemtype) && $itemtype == 'Group' ? $target['groups_id'] : null,
    'items_id_target' => isset($itemtype) && ($itemtype == 'Group' || $itemtype == 'User') && count($items_id_target) == 1 ?
        $items_id_target[0] : $items_id_target ?? null,
]));
